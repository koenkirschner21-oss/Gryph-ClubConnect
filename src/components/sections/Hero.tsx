...
const stats: StatItem[] = [
  { value: '50+', label: 'Clubs', numericEnd: 50, suffix: '+' },
  { value: '2,400+', label: 'Members', numericEnd: 2400, suffix: '+' },
...
function StatCounter({ item, animate }: { item: StatItem; animate: boolean }) {
  ...
  return (
    <div className="text-center sm:text-left">
      ...
      <div className="text-xs text-[#6E7681] mt-0.5">{item.label}</div>
    </div>
  );
}
...
export default function Hero({ onGetStarted }: { onGetStarted?: () => void }) {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#0D1117]">
      ...
      <div className="absolute -top-40 -right-40 w-[700px] h-[700px] rounded-full bg-[#C8102E] opacity-[0.06] blur-[120px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-[#8B949E] text-lg leading-relaxed max-w-lg">
              Replace scattered group chats, missed emails, and lost tasks. Built for University of Guelph student clubs.
            </p>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-4 -left-4 z-20 bg-[#161B22] border border-[#21262D] rounded-xl px-3 py-2.5 shadow-xl hidden sm:block"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -right-4 z-20 bg-[#161B22] border border-[#21262D] rounded-xl px-3 py-2.5 shadow-xl hidden sm:block"
            >
              <div className="flex items-center gap-2">
            ...
            {/* App mock */}
            <div className="w-full max-w-[480px] bg-[#161B22] border border-[#21262D] rounded-2xl overflow-hidden shadow-2xl shadow-black/50">
              {/* Titlebar */}
