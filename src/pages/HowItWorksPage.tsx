...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'No. Interest forms on this marketing site help us follow up. Real accounts live in the app when you are invited into early access.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Use Request a Demo on this site or email gryphclubconnect@gmail.com and tell us whether you are a student or club leader.',
  },
];
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <p className="text-[#9CA3AF] text-lg max-w-2xl mx-auto">
              Gryph ClubConnect is preparing for early access with students and club leaders. Involvement is about trying real workflows and sharing honest feedback — not instant full adoption.
            </p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#111111]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-10">
            <h2 className="text-3xl font-extrabold text-[#F5F5F5] font-sans mb-3">What you can explore</h2>
            <p className="text-[#9CA3AF]">Product workflows available depending on your role in early access.</p>
          </AnimatedSection>
      ...
      <section className="py-20 bg-[#0B0B0B]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            ...
            <p className="text-[#9CA3AF]">Straight answers for early access.</p>
          </AnimatedSection>
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 text-center">
          <AnimatedSection>
            ...
            <p className="text-[#9CA3AF] text-base mb-8 max-w-xl mx-auto">
              Request a demo or onboard your club. No account is created from this marketing site.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                ...
                size="lg"
                onClick={() =>
                  goToDemoForm({ interest: 'Onboard my club', navigate, pathname: '/how-it-works' })
                }
              >
                Onboard Your Club
              </Button>
              <Button
                ...
                size="lg"
                onClick={() =>
                  goToDemoForm({ interest: 'Request a demo', navigate, pathname: '/how-it-works' })
                }
              >
                Request a Demo
              </Button>
