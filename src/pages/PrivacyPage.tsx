        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatedSection delay={0.1}>
            <div className="space-y-8 text-[#9CA3AF] text-base leading-relaxed">
              <section>
                <h2 className="text-xl font-bold text-[#F5F5F5] font-sans mb-3">1. Information We Collect</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F5F5] font-sans mb-3">2. How We Use Your Information</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F5F5] font-sans mb-3">3. Data Storage &amp; Security</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F5F5] font-sans mb-3">4. Cookies</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F5F5] font-sans mb-3">5. Your Rights</h2>
                <p>You can request to view, update, or delete your personal data at any time by contacting us at <a href="mailto:hello@gryphclubconnect.com" className="text-[#E51937] hover:underline">hello@gryphclubconnect.com</a>.</p>
              </section>

              <section>
                <h2 className="text-xl font-bold text-[#F5F5F5] font-sans mb-3">6. Changes to This Policy</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-[#F5F5F5] font-sans mb-3">7. Contact</h2>
                <p>If you have any questions about this policy, please contact us at <a href="mailto:hello@gryphclubconnect.com" className="text-[#E51937] hover:underline">hello@gryphclubconnect.com</a>.</p>
              </section>
            </div>
          </AnimatedSection>
        </div>
